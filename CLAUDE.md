...
**Complete Guide:** See [`AGENTS.md`](AGENTS.md) for workflows and patterns.
...
| Skill                                                                     | Purpose                  |
| ------------------------------------------------------------------------- | ------------------------ |
| [scaffold-project](skills/project/scaffold-project/SKILL.md)              | Bootstrap from templates |
| [write-contracts](skills/move/write-contracts/SKILL.md)                   | Generate Move contracts  |
| [generate-tests](skills/move/generate-tests/SKILL.md)                     | Create test suites       |
| [security-audit](skills/move/security-audit/SKILL.md)                     | Audit before deployment  |
